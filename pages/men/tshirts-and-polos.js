...
const TshirtsAndPolos = ({products}) => {
  return (
    <>
    ...
    <Main>
          ...
          <Title>T-SHIRTS AND POLOS FOR MEN</Title>
          <ImageContainer>
          <Image src={InvertedLogo} alt="Vallonie Logo" />
          </ImageContainer>
      </Main>
      
        <Subtext>BROWSE A VARIETY OF T-SHIRTS AND POLO SHIRTS FOR MEN, CREATED FROM AUTHENTIC AND DELICATE FABRICS AND EMBELLISHED WITH ICONIC PRINTS. ROCK A T-SHIRT WITH A PAIR OF VALLONIE PANTS AND A SPRITZ OF COLOGNE.</Subtext>
...
export const getServerSideProps = async () => {
    const query = '*[_type == "maleTopsProduct"]';
...
export default TshirtsAndPolos
